...
public class AudioTool : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        audio_manager = EditorGUILayout.ObjectField("Audio_Manager:", audio_manager, typeof(GameObject), true) as GameObject;
        ScriptableObject target = audio_manager.GetComponent<Audio_Manager>().list;
